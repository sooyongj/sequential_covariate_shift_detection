...
def main(args):
  ...
  total_reject_fn = os.path.join(args.result_dir, 'result_kds_{}_sch{}_alpha{}_M{}_R{}_W{}_lr{:.4f}_seed{:}.csv'.format(args.model,
                                                                                                                        sch_name,
                                                                                                                        args.alpha,
                                                                                                                        args.n_samples,
                                                                                                                        args.n_repeats,
...
if __name__ == '__main__':
  ...
  config['handlers']['file_handler']['filename'] = os.path.join(args.log_dir, 'kds_dogs_log_{}.log'.format(date_str))
